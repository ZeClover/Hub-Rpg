...
import { editarEntidade, type Resultado } from "../../acoes";
    ...
    <form action={acao} className="space-y-4">
      ...
      <div>
        <label htmlFor="resumo" className={rotulo}>
          Resumo <span className="normal-case tracking-normal">(uma linha)</span>
        </label>
        <input
          id="resumo"
          name="resumo"
      ...
      <div className="flex items-center gap-4">
        <Botao />
        <Link
          href={`/universos/${slugUniverso}/cadastro/${slugEntidade}`}
