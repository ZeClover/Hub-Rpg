...
DO $$ BEGIN
  ALTER TABLE "grupos"
    ADD CONSTRAINT "grupos_campanhaId_fkey"
...
CREATE TABLE IF NOT EXISTS "grupos_membros" (
  ...
  "personagemId" uuid NOT NULL,
  CONSTRAINT "grupos_membros_pkey" PRIMARY KEY ("id")
);

CREATE UNIQUE INDEX IF NOT EXISTS "grupos_membros_grupoId_personagemId_key"
  ON "grupos_membros" ("grupoId", "personagemId");
...
DO $$ BEGIN
  ALTER TABLE "grupos_membros"
    ADD CONSTRAINT "grupos_membros_personagemId_fkey"
...
DO $$ BEGIN
  ALTER TABLE "itens"
    ADD CONSTRAINT "itens_donoId_fkey"
    FOREIGN KEY ("donoId") REFERENCES "usuarios"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "itens"
    ADD CONSTRAINT "itens_personagemId_fkey"
    FOREIGN KEY ("personagemId") REFERENCES "personagens"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "itens"
    ADD CONSTRAINT "itens_grupoId_fkey"
    FOREIGN KEY ("grupoId") REFERENCES "grupos"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "itens"
    ADD CONSTRAINT "itens_campanhaId_fkey"
    FOREIGN KEY ("campanhaId") REFERENCES "campanhas"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
...
CREATE TABLE IF NOT EXISTS "companheiros" (
  "id" uuid NOT NULL,
  "personagemId" uuid NOT NULL,
  "companheiroId" uuid NOT NULL,
  CONSTRAINT "companheiros_pkey" PRIMARY KEY ("id")
);

CREATE UNIQUE INDEX IF NOT EXISTS "companheiros_personagemId_companheiroId_key"
  ON "companheiros" ("personagemId", "companheiroId");

CREATE INDEX IF NOT EXISTS "companheiros_companheiroId_idx" ON "companheiros" ("companheiroId");

DO $$ BEGIN
  ALTER TABLE "companheiros"
    ADD CONSTRAINT "companheiros_personagemId_fkey"
    FOREIGN KEY ("personagemId") REFERENCES "personagens"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "companheiros"
    ADD CONSTRAINT "companheiros_companheiroId_fkey"
    FOREIGN KEY ("companheiroId") REFERENCES "personagens"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "veiculos"
    ADD CONSTRAINT "veiculos_campanhaId_fkey"
    FOREIGN KEY ("campanhaId") REFERENCES "campanhas"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "veiculos"
    ADD CONSTRAINT "veiculos_donoId_fkey"
    FOREIGN KEY ("donoId") REFERENCES "personagens"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
