...
DO $$ BEGIN
  CREATE TYPE "TipoCampoPersonalizado" AS ENUM ('TEXTO', 'NUMERO', 'CONTADOR', 'BOOLEANO');
EXCEPTION
...
DO $$ BEGIN
  ALTER TABLE "campos_personalizados"
    ADD CONSTRAINT "campos_personalizados_campanhaId_fkey"
    FOREIGN KEY ("campanhaId") REFERENCES "campanhas"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;

CREATE INDEX IF NOT EXISTS "campos_personalizados_campanhaId_idx"
  ON "campos_personalizados" ("campanhaId");

CREATE TABLE IF NOT EXISTS "conquistas_campanha" (
  "id" uuid NOT NULL,
  "campanhaId" uuid NOT NULL,
  "titulo" text NOT NULL,
  "descricao" text,
  "criadoEm" timestamp(3) NOT NULL DEFAULT now(),
  CONSTRAINT "conquistas_campanha_pkey" PRIMARY KEY ("id")
);

DO $$ BEGIN
  ALTER TABLE "conquistas_campanha"
    ADD CONSTRAINT "conquistas_campanha_campanhaId_fkey"
    FOREIGN KEY ("campanhaId") REFERENCES "campanhas"("id") ON DELETE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;

CREATE INDEX IF NOT EXISTS "conquistas_campanha_campanhaId_idx"
  ON "conquistas_campanha" ("campanhaId");
