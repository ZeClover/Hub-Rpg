...
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Terra Rank B**
      ...
      lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Terra Rank A**
      (19/09/2026) — decisão #147. As 10 jutsu do Rank A entraram no
...
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Vento Rank C**
      ...
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Vento Rank B**
      (19/09/2026) — decisão #151. As 14 jutsu do Rank B entraram no
      catálogo (58 de 74 jutsu de Vento; 335 de ~1400 no total). Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Vento Rank A**
      (19/09/2026) — decisão #152. As 10 jutsu do Rank A entraram no
...
- [x] **Naruto 5e — Liberação de Vento 100% completa** (19/09/2026) —
      ...
      com Playwright; `tsc`, lint, build e os 298 testes automáticos do
      projeto continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, início da Liberação de Fogo**
      (19/09/2026) — decisão #154. As 25 jutsu do Rank D da Liberação
...
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Fogo Rank C**
      ...
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Fogo Rank B**
...
- [x] **Naruto 5e — Catálogo de Jutsu, início da Liberação de Água**
      ...
      Natureza elemental. Testado com Playwright; `tsc` e lint
      continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Água Rank C**
...
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Água Rank B**
      ...
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Água Rank A**
      (19/09/2026) — decisão #162. As 9 jutsu do Rank A entraram no
...
- [x] **Naruto 5e — Catálogo de Jutsu, início da Liberação de Raio**
      ...
      continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Raio Rank C**
      (19/09/2026) — decisão #165. As 20 jutsu do Rank C entraram no
      catálogo (45 de 74 jutsu de Raio; 545 de ~1400 no total). Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Liberação de Raio Rank B**
...
- [x] **Naruto 5e — Todo o Ninjutsu Elemental 100% completo**
      ...
      Playwright; `tsc`, lint, build e os 298 testes automáticos do
      projeto continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, início do Genjutsu** (19/09/2026)
...
- [x] **Naruto 5e — Catálogo de Jutsu, Genjutsu Rank D (lote 1 de 5)**
      ...
      Testado com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Genjutsu Rank D (lote 2 de 5)**
      (19/09/2026) — decisão #171. Mais 24 jutsu do Rank D entraram no
...
- [x] **Naruto 5e — Catálogo de Jutsu, Genjutsu Rank C (lote 2 de 3)**
      ...
      limpos.
- [x] **Naruto 5e — Genjutsu Rank C 100% completo** (19/09/2026) —
      decisão #177. Os 20 jutsu do último lote fecharam o Rank C
      inteiro (60 jutsu) — Genjutsu tem agora os Ranks E, D e C 100%
      prontos (187 de 268 jutsu; 761 de ~1400 no total), faltando só
      B/A/S. Testado com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, início do Genjutsu Rank B (lote
      1 de 2)** (19/09/2026) — decisão #178. 23 dos 46 jutsu do Rank B
      entraram no catálogo (210 de 268 de Genjutsu; 784 de ~1400 no
      total). Testado com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Genjutsu Rank B 100% completo** (19/09/2026) —
      decisão #179. Os 23 jutsu do último lote fecharam o Rank B
...
- [x] **Naruto 5e — Genjutsu Rank A 100% completo** (19/09/2026) —
      ...
      Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Genjutsu 100% completo** (19/09/2026) — decisão
      #181. Os 13 jutsu do Rank S fecharam o Genjutsu inteiro (268
      jutsu, os 6 ranks E a S) — oitava categoria do Compêndio pronta,
...
- [x] **Naruto 5e — Catálogo de Jutsu, início do Taijutsu (lote 1 do
      ...
      Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Taijutsu Rank D (lote 2 de 3)**
...
- [x] **Naruto 5e — Taijutsu Rank C quase completo (43/44)** (19/09/2026)
      ...
      continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, início do Taijutsu Rank B (lote
...
- [x] **Naruto 5e — Taijutsu Rank B 100% completo** (19/09/2026) —
      ...
      limpos.
- [x] **Naruto 5e — Taijutsu Rank A 100% completo** (19/09/2026) —
...
- [x] **Naruto 5e — Taijutsu 100% completo** (19/09/2026) — decisão
      ...
      `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, início do Bukijutsu Rank D (lote
      1 de 6)** (19/09/2026) — decisão #191. 20 dos 114 jutsu do Rank D
      de Bukijutsu (a maior categoria do Compêndio, 383 jutsu) entraram
      no catálogo — 1036 de ~1400 no total. Testado com Playwright;
      `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank D (lote 2 de
      6)** (19/09/2026) — decisão #192. Mais 20 jutsu do Rank D de
      Bukijutsu (40 de 114 no total) — 1056 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank D (lote 3 de
      6)** (19/09/2026) — decisão #193. Mais 20 jutsu do Rank D de
      Bukijutsu (60 de 114 no total) — 1076 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank D (lote 4 de
      6)** (19/09/2026) — decisão #194. Mais 20 jutsu do Rank D de
      Bukijutsu (80 de 114 no total) — 1096 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank D (lote 5 de
      6)** (19/09/2026) — decisão #195. Mais 20 jutsu do Rank D de
      Bukijutsu (100 de 114 no total) — 1116 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Bukijutsu Rank D quase completo (113/114)**
      (19/09/2026) — decisão #196. Último lote (13 jutsu) fechou o
      Rank D de Bukijutsu — só "Stone Form" fora (dados vazios na
      extração, mesmo padrão de "Shadow Dancing Leaf") — 1129 de ~1400
      no total. Testado com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, início do Bukijutsu Rank C (lote
      1 de ~5)** (19/09/2026) — decisão #197. 20 dos 99 jutsu do Rank C
      de Bukijutsu entraram no catálogo — 1149 de ~1400 no total.
      Testado com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank C (lote 2 de
...
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank C (lote 3 de
      ...
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank C (lote 4 de
      ~5)** (19/09/2026) — decisão #200. Mais 20 jutsu do Rank C de
      Bukijutsu (80 de 99 no total) — 1209 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Bukijutsu Rank C 100% completo** (19/09/2026) —
      decisão #201. Último lote (19 jutsu) fechou o Rank C de
      Bukijutsu, sem pendências de dados corrompidos neste rank — 1228
      de ~1400 no total. Testado com Playwright; `tsc` e lint
      continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, início do Bukijutsu Rank B (lote
      1 de ~5)** (24/09/2026) — decisão #202. Primeiros 17 jutsu do
      Rank B de Bukijutsu (17 de 81 no total) — 1245 de ~1400 no
      total. Testado com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank B (lote 2 de
      ~5)** (24/09/2026) — decisão #203. Mais 17 jutsu do Rank B de
      Bukijutsu (34 de 81 no total) — 1262 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank B (lote 3 de
      ~5)** (24/09/2026) — decisão #204. Mais 17 jutsu do Rank B de
      Bukijutsu (51 de 81 no total) — 1279 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank B (lote 4 de
      ~5)** (24/09/2026) — decisão #205. Mais 17 jutsu do Rank B de
      Bukijutsu (68 de 81 no total) — 1296 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Bukijutsu Rank B 100% completo** (24/09/2026) —
      decisão #206. Último lote (13 jutsu) fechou o Rank B de
      Bukijutsu, sem pendências de dados corrompidos neste rank — 1309
      de ~1400 no total. Testado com Playwright; `tsc` e lint
      continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank A (lote 1 de
      ~4)** (24/09/2026) — decisão #207. Primeiros 16 jutsu do Rank A
      de Bukijutsu (16 de 64 no total) — 1325 de ~1400 no total.
      Testado com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank A (lote 2 de
      ~4)** (24/09/2026) — decisão #208. Mais 16 jutsu do Rank A de
      Bukijutsu (32 de 64 no total) — 1341 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [x] **Naruto 5e — Catálogo de Jutsu, Bukijutsu Rank A (lote 3 de
      ~4)** (24/09/2026) — decisão #209. Mais 16 jutsu do Rank A de
      Bukijutsu (48 de 64 no total) — 1357 de ~1400 no total. Testado
      com Playwright; `tsc` e lint continuam limpos.
- [ ] Naruto 5e — resto dos Clãs (Iburi a Yuki), resto do Catálogo de
      Jutsu (~41 jutsu: "Shadow Dancing Leaf" e "Stone Form"
      pendentes, Rank A de Bukijutsu — 16 restantes de 64 — e Rank S de
      Bukijutsu inteiro — 25 jutsu — categoria por categoria),
